...
# #1
 ...
 # #5
   ...
   context "Imnporting from entries_2.csv" do
    it "imports the correct number of entries" do
   ...
   describe "remove_entry" do
    it "removes entries not registered in the directory or address book" do
     book = AddressBook.new
     book.add_entry("Kevin Spacey", "123.456.7890", "kspacey@lovelace.com")
     n = "Ada Lovelace"
     ph = "010.012.1815"
     email = "augusta.king@lovelace.com"
     book.add_entry(n, ph, email)
     expect(book.entries.size).to eq(2)
     book.remove_entry(n, ph, email)
     expect(book.entries.size).to eq(1)
